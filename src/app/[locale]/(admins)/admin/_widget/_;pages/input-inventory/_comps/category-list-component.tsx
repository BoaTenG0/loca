...
export const CategoryListTabs: React.FC<PlotTabsProps> = ({ value, handleChange, labels }) => {
  return (
...
export const CategoryListDrawerDetails: React.FC<{
...
export const CategoryListDrawerEdit: React.FC<{
    ...
    <div>
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-5 ">
          <div className="my-2 ">
            <label htmlFor="categoryName" className="block mb-3 text-sm text-locaGreen">
              Category name
            </label>
            <input
              type="text"
