...
export const InputInventoryTabs: React.FC<PlotTabsProps> = ({ value, handleChange, labels }) => {
  return (
...
export const InputInventoryDrawerDetails: React.FC<{
...
export const InputInventoryDrawerEdit: React.FC<{
    ...
    <div>
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-5 ">
          <div className="my-2 ">
            <label htmlFor="name" className="block mb-3 text-sm text-locaGreen">
              Input name
            </label>
            <input
              type="text"
              id="name"
              name="name"
              defaultValue={modalView === 'edit' ? 'Fertilizer ' : ''}
              className=" px-3 py-2  w-[90%] border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-locaGreen focus:border-transparent"
            />
          </div>

          <div className="space-y-2">
            <label htmlFor="category" className="block text-sm  mb-3 text-logaTextGreen">
              Category
            </label>
            <div className="relative">
              <select
                id="category"
                name="category"
                className=" w-[90%] px-3 py-2 bg-gray-100 rounded-md text-gray-900 appearance-none focus:outline-none focus:ring-2 focus:ring-locaGreen"
              >
          ...
          <div className="space-y-2">
            <label htmlFor="price" className="block text-sm  mb-3 text-logaTextGreen">
              Price
            </label>
            <input
              type="number"
          ...
          <div className="space-y-2">
            <label htmlFor="supplier" className="block text-sm  mb-3 text-logaTextGreen">
              Supplier
            </label>
            <div className="">
              <select
          ...
          <div className="space-y-2">
            <label htmlFor="stock" className="block text-sm  mb-3 text-logaTextGreen">
              Stock
            </label>
            <input
              type="number"
