...
import { ArrowDown, ArrowLeft2, ArrowRight2, Filter, Trash } from 'iconsax-react'
          ...
          return (
            <th key={headCell.id} aria-sort={active ? ({ asc: 'ascending', desc: 'descending' } as const)[order] : undefined}>
              ...
              <Link
                ...
                startDecorator={headCell.numeric ? <ArrowDown style={active ? { opacity: 1 } : { opacity: 0 }} /> : null}
                endDecorator={!headCell.numeric ? <ArrowDown style={active ? { opacity: 1 } : { opacity: 0 }} /> : null}
                sx={{
                  fontWeight: 'lg',
