...
const Header = (props: { sidebarOpen: string | boolean | undefined; setSidebarOpen: (arg0: boolean) => void }) => {
  return (
    <header className="sticky top-0 z-50 flex w-full border-b border-stroke bg-white ">
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
          ...
          >
            <span className="relative block h-5.5 w-5.5 cursor-pointer">
              <span className="du-block absolute right-0 h-full w-full">
                <span
                  className={`relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm bg-dark duration-200 ease-in-out dark:bg-white ${
        ...
        <div className="flex items-center justify-normal lg:w-full lg:justify-between xl:w-auto xl:justify-normal">
          <SearchForm />
        </div>
