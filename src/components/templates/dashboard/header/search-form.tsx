        ...
        <form>
          <div className="relative w-full max-w-[300px]">
            ...
            <input
              type="text"
              placeholder="Search"
              className="w-full rounded-full border border-stroke bg-gray-2 py-2  px-10 text-dark focus:border-primary focus:outline-none dark:focus:border-primary xl:w-[800px]"
            />
          </div>
        </form>
      </li>
