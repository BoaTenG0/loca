    ...
    <>
      <div className="flex w-full rounded-[10px] border-l-6 border-green bg-green-light-7 px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
        ...
        <div className="w-full">
          <h5 className="mb-2 font-bold leading-[22px] text-[#004434] dark:text-[#34D399]">Message Sent Successfully</h5>
          <p className="text-[#637381]">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
      </div>
    </>
  )
  ...
  return (
    <>
      <div className="flex w-full rounded-[10px] border-l-6 border-red-light bg-red-light-5 px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
        ...
        <div className="w-full">
          <h5 className="mb-4 font-bold leading-[22px] text-[#BC1C21]">There were 1 errors with your submission</h5>
          <ul>
  ...
  return (
    <>
      <div className="flex w-full rounded-[10px] border-l-6 border-[#FFB800] bg-[#FEF5DE] px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
        ...
        <div className="w-full">
          <h5 className="mb-3.5 text-lg font-bold leading-[22px] text-[#9D5425]">Attention needed</h5>
